...
export class DevolucaoCompraComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('rv-devolucao-compra div table .btn-danger'));
  title = element.all(by.css('rv-devolucao-compra div h2#page-heading span')).first();
...
export class DevolucaoCompraUpdatePage {
  pageTitle = element(by.id('rv-devolucao-compra-heading'));
...
export class DevolucaoCompraDeleteDialog {
  private dialogTitle = element(by.id('rv-delete-devolucaoCompra-heading'));
  private confirmButton = element(by.id('rv-confirm-delete-devolucaoCompra'));
