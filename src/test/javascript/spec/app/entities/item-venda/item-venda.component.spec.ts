...
import { ItemVendaComponent } from 'app/entities/item-venda/item-venda.component';
...
describe('Component Tests', () => {
  describe('ItemVenda Management Component', () => {
    let comp: ItemVendaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ItemVendaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.itemVendas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
