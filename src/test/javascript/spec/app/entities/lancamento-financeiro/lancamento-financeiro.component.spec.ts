...
import { LancamentoFinanceiroComponent } from 'app/entities/lancamento-financeiro/lancamento-financeiro.component';
...
describe('Component Tests', () => {
  describe('LancamentoFinanceiro Management Component', () => {
    let comp: LancamentoFinanceiroComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LancamentoFinanceiroComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new LancamentoFinanceiro(123)],
            headers
          })
        )
      );
      ...
      expect(comp.lancamentoFinanceiros[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
