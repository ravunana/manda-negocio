...
import { UnidadeMedidaComponent } from 'app/entities/unidade-medida/unidade-medida.component';
...
describe('Component Tests', () => {
  describe('UnidadeMedida Management Component', () => {
    let comp: UnidadeMedidaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UnidadeMedidaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.unidadeMedidas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
