...
import { LocalArmazenamentoComponent } from 'app/entities/local-armazenamento/local-armazenamento.component';
...
describe('Component Tests', () => {
  describe('LocalArmazenamento Management Component', () => {
    let comp: LocalArmazenamentoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LocalArmazenamentoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new LocalArmazenamento(123)],
            headers
          })
        )
      );
      ...
      expect(comp.localArmazenamentos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
