...
import { RvHealthCheckComponent } from 'app/admin/health/health.component';
import { RvHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
  describe('RvHealthCheckComponent', () => {
    let comp: RvHealthCheckComponent;
    let fixture: ComponentFixture<RvHealthCheckComponent>;
    let service: RvHealthService;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [MandaTestModule],
        declarations: [RvHealthCheckComponent]
      })
        .overrideTemplate(RvHealthCheckComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(RvHealthCheckComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(RvHealthService);
    });
