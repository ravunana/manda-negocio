...
import { RvLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
  describe('LoginComponent', () => {
    let comp: RvLoginModalComponent;
    let fixture: ComponentFixture<RvLoginModalComponent>;
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [RvLoginModalComponent],
        providers: [
          FormBuilder,
          {
        ...
        .overrideTemplate(RvLoginModalComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(RvLoginModalComponent);
