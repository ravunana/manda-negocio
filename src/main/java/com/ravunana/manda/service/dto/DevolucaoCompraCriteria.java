...
/**
 * Criteria class for the {@link com.ravunana.manda.domain.DevolucaoCompra} entity. This class is used
 * in {@link com.ravunana.manda.web.rest.DevolucaoCompraResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /devolucao-compras?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class DevolucaoCompraCriteria implements Serializable, Criteria {
    ...
    public DevolucaoCompraCriteria(){
    }

    public DevolucaoCompraCriteria(DevolucaoCompraCriteria other){
    ...
    @Override
    public DevolucaoCompraCriteria copy() {
        return new DevolucaoCompraCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final DevolucaoCompraCriteria that = (DevolucaoCompraCriteria) o;
        return
    ...
    public String toString() {
        return "DevolucaoCompraCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
