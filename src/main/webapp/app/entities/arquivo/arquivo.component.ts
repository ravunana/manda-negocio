...
export class ArquivoComponent implements OnInit, OnDestroy {
  ...
  trackId(index: number, item: IArquivo) {
    return item.id;
  }
  ...
  registerChangeInArquivos() {
    this.eventSubscriber = this.eventManager.subscribe('arquivoListModification', () => this.loadAll());
  }

  delete(arquivo: IArquivo) {
  ...
  protected paginateArquivos(data: IArquivo[], headers: HttpHeaders) {
